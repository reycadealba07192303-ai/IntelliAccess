  ...
  return (
    <div className="space-y-6">
      ...
      <GlassCard className="relative overflow-hidden p-0 group">
        <div className="relative p-8 transition-all duration-300 bg-gradient-to-r from-purple-600 via-pink-500 to-purple-600">
          {/* Cover Photo Overlay */}
          <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors duration-300" />          <div className="flex items-center gap-6 relative z-10 pt-4">
      ...
      <div className="grid gap-6 md:grid-cols-3">
        <GlassCard className="p-6">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              ...
              <p className="text-lg font-bold text-white">Feb 2026</p>
            </div>
          </div>
        </GlassCard>
        ...
        <GlassCard className="p-6">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <p className="text-xs font-semibold uppercase tracking-wider text-slate-500">Timezone</p>
              <p className="text-lg font-bold text-white">Asia/Manila</p>
            </div>
          </div>
        </GlassCard>
      </div>
        ...
        <div className="mt-8 flex justify-end gap-3">
          {!isEditing ? (
            ...
            <>
              ...
              <GlassButton className="flex items-center gap-2" onClick={handleSave}>
